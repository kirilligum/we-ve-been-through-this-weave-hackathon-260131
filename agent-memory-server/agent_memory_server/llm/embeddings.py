...
class DeterministicEmbeddings(Embeddings):
    """Deterministic local embeddings for demos/tests without external API calls."""
    ...
    def embed_documents(self, texts: list[str]) -> list[list[float]]:
        return [self._vector_for_text(text or "") for text in texts]

    def embed_query(self, text: str) -> list[float]:
        return self._vector_for_text(text or "")
