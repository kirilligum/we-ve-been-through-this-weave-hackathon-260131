...
class MemoryEditingAgent:
    ...
    def _setup_llm(self):
        ...
        memory_tool_dicts = memory_tool_schemas.to_list()

        # Extract function schemas for OpenAI
        available_functions = [tool["function"] for tool in memory_tool_dicts]
        ...
        self.llm = ChatOpenAI(model="gpt-4o", temperature=0.3).bind_tools(
            memory_tool_dicts,  # Use full tool schemas, not just functions
